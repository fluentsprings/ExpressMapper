...
namespace ExpressMapper.Tests.Model.ViewModels
{
    public class SizeViewModel : IEquatable<SizeViewModel>
    {
        ...
        {
            return Id == other.Id && Name == other.Name && Alias == other.Alias && NotNullable == other.NotNullable && Nullable.GetValueOrDefault() == other.Nullable.GetValueOrDefault() && SortOrder == other.SortOrder && Fullname == other.Fullname;
        }
    }
}
